...
func main() {
	...
	// Variable in Go Language
	// Variable Naming Rules
	// 1. Variable names must begin with a letter or an underscore (_).
	// 2. Variable names can contain the letters a-z, A-Z, the numbers 0-9, and the underscore (_).
	// 3. Variable names are case-sensitive.
	// 4. Variable names cannot be keywords or Go reserved words.

	// Examples of reserved words in the language Go
	...
	// <variable_name> := <value>
	// Use when you want to declare a variable and set its value at the same time.
	// No data type is required.
	// Use when you want to declare a variable and set its value at the same time.
	// No data type is required.

	// Example of using type inference.
	var a = 10
	var b = 10.5
	var c = "Hello, World!"
	var d = true
	...
	// 8. Variable scope
	// Variables declared within a function have scope within that function.
	// Variables declared within a block have scope within that block.
	// Variables declared with var have scope within that function.
	// Variables declared with := have scope within that block.

	// Examples of variable scope
	var mywordLocal string = "Awesome Local Variable"
	fmt.Println(myworldGlob)
	fmt.Println(mywordLocal)
